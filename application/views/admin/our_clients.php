        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('admin/our_clients/add') ?>">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                            $sno = 1;
                            foreach ($our_clients as $key => $value) {
                            ?>
                                <tr>
                                    <td><?= $sno ?></td>
                                    <td><?= $value->title ?></td>
                                    ...
                                    <td><?= $value->rating ?></td>
                                    <td>
                                        <a href="<?= base_url('admin/our_clients/edit/') . $value->id ?>">
                                            <button class="add-button">
                                                Edit
                                            </button>
                                        </a>
                                        <br>
                                        <a href="<?= base_url('admin/our_clients/delete/') . $value->id ?>">
                                            <button class="add-button">
                                                Delete
                                            </button>
                                        </a>
