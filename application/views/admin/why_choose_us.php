...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Why Choose Us</h1>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <a href="<?= base_url('admin/why_choose_us/add') ?>">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $value->icon ?></td>
                                    <td>
                                        <a href="<?= base_url('admin/why_choose_us/edit/') . $value->id ?>">
                                            <button class="add-button">
                                                Edit
                                            </button>
                                        </a>
                                        <br>
                                        <a href="<?= base_url('admin/why_choose_us/delete/') . $value->id ?>">
                                            <button class="add-button">
                                                Delete
                                            </button>
                                        </a>
